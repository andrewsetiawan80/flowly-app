    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500 text-white shadow-lg shadow-orange-500/25 hover:from-orange-600 hover:via-amber-600 hover:to-orange-600 hover:shadow-xl hover:shadow-orange-500/35 active:scale-[0.98] border-0":
              variant === "default",
            "bg-red-500 text-white shadow-md shadow-red-500/20 hover:bg-red-600 hover:shadow-lg hover:shadow-red-500/30 active:scale-[0.98]":
              variant === "destructive",
            "border border-black/[0.08] dark:border-white/[0.08] bg-white/50 dark:bg-white/[0.02] backdrop-blur-sm hover:bg-white/80 dark:hover:bg-white/[0.04] hover:border-orange-500/20 active:scale-[0.98]":
              variant === "outline",
            ...
            "text-orange-600 dark:text-orange-400 underline-offset-4 hover:underline": variant === "link",
